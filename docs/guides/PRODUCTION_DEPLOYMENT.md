...
The transient service reads the protected environment file without expanding its secrets into shell arguments. A successful current schema reports nine applied and zero pending migrations.
