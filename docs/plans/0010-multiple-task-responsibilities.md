...
The focused frontend contract is `docs/integrations/FRONTEND_TASK_RESPONSIBILITIES_V2.md`. It records the V1-to-V2 route migration, TypeScript types, complete-set update semantics, safe V1 coexistence, optimistic-conflict recovery, and the current Admin-only assignee-candidate query limitation.
